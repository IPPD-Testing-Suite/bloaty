// Fuzzer harness targeting DWARF string table parsing.
// Exercises ReadNullTerminated in util.cc via DWARF string attribute reading.
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size) {
  ...
  bloaty::RunBloaty(factory, "compileunits");
  bloaty::RunBloaty(factory, "inlines");
  bloaty::RunBloaty(factory, "symbols");
